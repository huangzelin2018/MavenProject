...
!function ($) {
    $.Huifold = function (obj, obj_c, speed, obj_type, Event) {
        if (obj_type == 2) {
//			$(obj + ":first").find("b").removeClass("ico_plus").addClass('ico_minus');
            $(obj_c + ":first").show();
        }
        $(obj).on(Event,
                function () {
...
//					if ($(this).find("b")) {
//						$(this).find("b").removeClass("ico_minus").addClass('ico_plus');
//					}
                        }
                    } else {
                        if (obj_type == 3) {
...
//					if ($(this).find("b")) {
//						$(this).find("b").removeClass("ico_plus").addClass('ico_minus');
//					}
                        } else {
                            $(obj_c).slideUp(speed);
                            $(obj).removeClass("selected");
//					if ($(this).find("b")) {
//						$(obj).find("b").removeClass("ico_minus").addClass('ico_plus');
//					}
                            $(this).next().slideDown(speed).end().addClass("selected");
//					if ($(this).find("b")) {
//						$(this).find("b").removeClass("ico_plus").addClass('ico_minus');
